document.addEventListener('DOMContentLoaded', function() {
    ...
    const storyLines = [
        ...
        {text: "A shadow descended upon the city of Nairobi...", delay: 1000, speed: 65},
        {text: "They say he walks through walls...", delay: 900, speed: 60},
        {text: "They say time stops when he lifts his camera.", delay: 1000, speed: 75, em: true},
        {text: "", delay: 600, speed: 0},
        {text: "In the alleys where the lost souls wander...", delay: 800, speed: 65},
        {text: "In the halls where the powerful kneel...", delay: 800, speed: 65},
        {text: "One name is whispered in the dark...", delay: 900, speed: 60},
        {text: "A name that makes the mighty tremble.", delay: 1000, speed: 70, em: true},
        {text: "", delay: 500, speed: 0},
        {text: "CUGNOT.", delay: 1500, speed: 120, strong: true},
        {text: "", delay: 700, speed: 0},
        {text: "Born from the concrete jungle...", delay: 800, speed: 65},
        {text: "Forged in the fires of ten thousand sunsets...", delay: 900, speed: 65},
        {text: "He does not take pictures...", delay: 800, speed: 70},
        {text: "He claims souls.", delay: 1200, speed: 90, em: true},
        {text: "", delay: 600, speed: 0},
        {text: "From the sacred altars of wedding vows...", delay: 800, speed: 65},
        {text: "To the throne rooms of graduation halls...", delay: 800, speed: 65},
        {text: "From the miracle of life growing within...", delay: 800, speed: 65},
        {text: "To the wild celebrations of those who survive another year...", delay: 900, speed: 65},
        {text: "", delay: 500, speed: 0},
        {text: "Every frame... is a contract with eternity.", delay: 1100, speed: 70, em: true},
        {text: "", delay: 700, speed: 0},
        {text: "You have been summoned...", delay: 900, speed: 75},
        {text: "Bear witness to the legend...", delay: 900, speed: 70},
        {text: "CUGNOT PHOTOGRAPHY", delay: 2000, speed: 100, neon: true}
    ];
